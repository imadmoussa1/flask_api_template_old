...
class Config(object):
  ...
  _blogs_database_name = None
  _blogs_drafts_collection_name = None
  ...
  def blogs_database_name():
    if Config._blogs_database_name is None:
      Config._blogs_database_name = os.getenv('BLOGS_DATABASE_NAME', 'blogs_data')
    return Config._blogs_database_name

  @staticmethod
  def score_collection_name():
    if Config._blogs_drafts_collection_name is None:
      Config._blogs_drafts_collection_name = os.getenv('BLOGS_DRAFTS_COLLECTION_NAME', 'blogs_drafts')
    return Config._blogs_drafts_collection_name
